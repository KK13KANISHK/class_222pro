...
def check_traffic_lights():
    ...
    if dropped_vehicle.is_at_traffic_light():
        ...
        if traffic_light.get_state() == carla.TrafficLightState.Yellow:
            ...
            dropped_vehicle.apply_control(carla.VehicleControl(throttle = 0.5, steer = 0.15))
            time.sleep(5)
            dropped_vehicle.apply_control(carla.VehicleControl(throttle = 0.10, steer = 0.1))
            dropped_vehicle.apply_control(carla.VehicleControl(throttle= 0.24))
